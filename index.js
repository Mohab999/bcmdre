...
if(!message.author.id === '516226504066072588') return;
...
m.sendMessage(args)
  ...
  client.on("message", message => {
   ...
   client.on("message", message => {
    if (message.content === "adasadwasawdasawdaws") {
     const embed = new Discord.RichEmbed()
         .setColor("RANDOM")
   ...
   client.on("message", message => {
    if (message.content === "aawdafaefawdaswdaw") {
     const embed = new Discord.RichEmbed()
         .setColor("RANDOM")
...
client.on('ready', () => {
    console.log(`Logged in as ${client.user.tag} !`);
          client.user.setActivity("*help | Test",{type: 'WATCHING'});
